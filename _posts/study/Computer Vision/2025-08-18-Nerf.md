...
Some notes are from [Volumetric Rendering Techniques GPU Gems](https://developer.nvidia.com/gpugems/gpugems/part-vi-beyond-triangles/chapter-39-volume-rendering-techniques) and my post about [Volume Rendering](https://sjang1594.github.io/study/Volume-Rendering.html)
...
### NeRF Overview
Since we cover the major components above, let's look into detail with volume rendering and what are their goal. First of all, volume rendering itself is a differetiable function, which means we can 
...
### Some NerF History
* [Soft3D](https://ericpenner.github.io/soft3d/)
* [Multiplane Image Methods](https://single-view-mpi.github.io/)
